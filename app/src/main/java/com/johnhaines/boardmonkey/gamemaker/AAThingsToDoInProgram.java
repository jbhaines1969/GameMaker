...
/**
 * Created by Terri on 11/15/2016.
 */
...
public class AAThingsToDoInProgram {
    ...
    // TODO write and test pause (current activity/frag persistence) and stop (current activity, fragment, and game persistence) and start and resume functionality

    // TODO create end product graphics, program screens accordingly
